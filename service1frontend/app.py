...
def play(given_word):
    ...
    if given_word == "feeling_lucky_punk":
        ...
        bc = (requests.post('http://magicmaker:5003/random_number_generator/', json = data)).text
        ...
        bc = (requests.post('http://magicmaker:5003/rand_numbers_from_word', json = data)).text
